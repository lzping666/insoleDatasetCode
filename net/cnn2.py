...
class CNNModel(nn.Module):
    def __init__(self, input_size, hidden_size, num_layers, output_size, dropout_rate=0.2):
        ...
        # 深度可分离卷积块
        self.depthwise_convs = nn.Sequential(
...
#         # CNN expects: (batch_size, input_size, seq_len)
#         x = x.transpose(1, 2)
#
#         # Initial batch norm
...
class PyTorchFSRPredictor:
    ...
    def build_model(self, input_size, output_size):
        return CNNModel(input_size, self.hidden_size, self.num_layers, output_size, self.dropout_rate)
